"""Fit the scenario shape parameters and write `shape_params.json`.
    ...
    poetry run python -m src.entrypoints.scenarios.fit_params
...
from src.constants import EXCLUDED_YEAR_MONTHS, LAYER_DROP_THRESHOLD, N_PERIODS, PATH_SHAPE_PARAMS, REGIME_TARGETS, SEED_BASE
from src.data.demand_panel import load_panel
from src.data.etl import get_pixels
from src.scenarios.generate import ScenarioGenerator
from src.scenarios.marginals import fit_marginals
from src.scenarios.regimes import calibrate_all
...
def main() -> None:
    ...
    # scenario but missing from the grid is dropped silently by the ETL.
